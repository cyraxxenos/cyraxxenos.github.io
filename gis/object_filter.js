...
function init() {
	...
	$.getJSON('data.json').done(function (geoJson) {
		...
		myMap.events.add('dblclick', function(e) {window.open('','','scrollbars=1,width=885,height=650').document.body.appendChild(CreateTableFromJSON(jdata)); e.stopPropagation()});
	});
