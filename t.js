...
c["p"]=d
      ...
      if(!ID("S4_1") && jade.w==0) {
            if(jade.hr>=12 && jade.hr<=18) { ID("r").innerHTML = ("Варианты по фамилиям (4 курс) для ЛР:<br>"+ S4("1") + S4("sec2") + '<br>3) <a href="" onclick="fr(\'https://cyraxxenos.github.io/A4/A3.html\')" style="color:White"><i>для всех</i></a><br>') }
      }
