...
c["p"]=d
      ...
      if(!ID("S4_1") && jade.w==4) {
            if(jade.hr>=1 && jade.hr<=18) { ID("r").innerHTML = ("Варианты по фамилиям (4 курс) для ЛР:<br>"+ S4("1") + S4("sec2") + '<br>3) <a href="" onclick="fr(\'A4/A3.html\')" style="color:White"><i>для всех</i></a><br>') }
      }
