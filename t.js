...
c["p"]=d
      ...
      if(!ID("S4_1") && jade.w==6) {
            if(jade.hr>=10 && jade.hr<=15) { ID("r").innerHTML = ("Варианты по фамилиям (4 курс) для ЛР:<br>"+ S4("1") + S4("sec2") + '<br>3) <a href="" onclick="fr(\'A4/A3.html\')" style="color:White"><i>для всех</i></a><br>') }
      }
